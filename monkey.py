...
from kivy.graphics import RenderContext, Callback, PushMatrix, PopMatrix, \
    Color, Translate, Rotate, Mesh, UpdateNormalMatrix, Rectangle
...
class Renderer(Widget):
    def __init__(self, **kwargs):
        ...
        self.canvas = Fbo(compute_normal_mat=True)
        self.canvas.shader.source = resource_find('simple.glsl')
        self.scene = ObjFile(resource_find("template.obj"), mode='file')
        #super(Renderer, self).__init__(**kwargs)
        with self.canvas:
